...
public class GUI extends JFrame implements ActionListener{
    ...
    public void initPanel(){
        ...
        jscrollPane.setBounds(10,170, 700, 700);
        ...
        outText_textarea.setText(
                "使用说明：\n" +
                        ...
                        "b. 在使用默认值时会输出到本程序所在目录下的Answers.txt 和 Exercises.txt\n" +
                        "2. 作业检查：\n" +
        ...
        if(event.getSource().equals(start_button)){
            ...
            if (directoryPath_textField.getText().equals("") || outputFilePath_textField.getText().equals("")) {
                ...
                if (actionCombobox.getSelectedIndex() == 0){
                    try {
                        output = Arithmetic.work(Integer.parseInt(maxNumber), Integer.parseInt(rangeValue), directoryPath, outputFilePath);
                    ...
                    try {
                        output = Arithmetic.check(directoryPath, outputFilePath, gradePath);
                        outText_textarea.setText(output);
                    } catch (IOException e) {
